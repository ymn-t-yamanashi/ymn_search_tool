...
#
#     PHX_SERVER=true bin/ymn_tool start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ymn_tool, YmnToolWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  # variable instead.
  secret_key_base = "5cDbbeNhukatK07RTz7UUGWjBCZ/vONTXhyC843E5gGkWas1Ye3aDPrQ5+8/9ei5"
  # secret_key_base =
  ...
  host = System.get_env("PHX_HOST") || "tool.ymnbuild.org"
  ...
  #
  #     config :ymn_tool, YmnTool.Mailer,
